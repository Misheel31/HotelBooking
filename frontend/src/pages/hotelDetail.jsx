              ...
              <div className="sticky top-8 bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <div className="flex items-center border p-3 rounded-lg">
                        ...
                        <button
                          onClick={() =>
                            setRoomCount(Math.min(5, roomCount + 1))
                          }
                          className="px-2"
                        >
                          +
                  ...
                  <button
                    ...
                    className="w-full bg-blue-400 text-white font-semibold py-4 rounded-xl hover:bg-blue-700"
                  >
                    Book Now
                  </button>

                  <div className="text-center text-sm text-gray-500 mt-2">
                    <Shield className="w-4 h-4 inline" /> Free cancellation
                    within 24 hours
                  </div>
                </div>
              </div>
